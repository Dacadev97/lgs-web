                        ...
                        <div class="lg:col-span-3 space-y-6">
                            ...
                            <div class="grid grid-cols-3 gap-6 pt-6">
                                <div class="text-center">
                                    ...
                                    <div class="text-sm lg:text-base text-gray-600 font-medium">Años de Experiencia</div>
                                </div>
                                <div class="text-center border-x border-gray-200">
                                    <div class="text-3xl lg:text-4xl font-bold text-amber-600 mb-2">{{ $settings->compositions_count }}</div>
                                    <div class="text-sm lg:text-base text-gray-600 font-medium">Composiciones</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-3xl lg:text-4xl font-bold text-amber-600 mb-2">{{ $settings->performances_count }}</div>
                                    <div class="text-sm lg:text-base text-gray-600 font-medium">Presentaciones</div>
                                </div>
                            </div>
                        </div>
                    </div>
