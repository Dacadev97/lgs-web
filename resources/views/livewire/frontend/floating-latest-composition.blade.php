<div>
    @if($latestComposition && $visible)
        <div
            ...
            class="fixed -bottom-20 -right-20 md:bottom-8 md:right-8 z-[999999] w-72 bg-gradient-to-br from-white to-amber-50 rounded-lg shadow-xl border border-amber-200 overflow-hidden hover:shadow-2xl transform-gpu transition-all duration-300 ease-in-out group"
